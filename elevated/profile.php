	  			...
	  			while ($row=mysqli_fetch_row($result))
	    		{
						...
						<div class="container-fluid text-center align-items-center padding border" style="padding-bottom:100px;">
								<div class="row">
	    							...
	    							<h3>Elevated User Operations :</h3>
	    									
	    										<a href="Requests.php" class="btn btn-primary">Check Requests</a><br><br>
	    										<a href="allusers.php" class="btn btn-primary">View All Users</a><br>	
	    								</div>
